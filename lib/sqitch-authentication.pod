...
able to use a protected password file. This is a file with access limited only
...
contains lines specifying authentication rules as follows:
...
See L<sqitch-target> and L<sqitch-configuration> for details  on target
configuration.
